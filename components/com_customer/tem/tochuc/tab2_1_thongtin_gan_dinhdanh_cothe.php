...
$objFieldInfo->getList(" AND sub_cat_id='".SUB_TC_NDD_THONGTIN_DINHDANH_GANCOTHE."'", " ORDER BY sort asc");
$icon = "";
$i=0;
...
?>
	...
	<section class="col col-3">
		...
		<label class="textarea">
			...
			<textarea name="gr11_<?php echo SUB_TC_NDD_THONGTIN_DINHDANH_GANCOTHE;?>_<?php echo $rs['alias']?>[]" id="<?php echo $rs['alias']?>"><?php echo $valueData;?></textarea>											
		</label>
	</section>
	<?php endif; ?>
