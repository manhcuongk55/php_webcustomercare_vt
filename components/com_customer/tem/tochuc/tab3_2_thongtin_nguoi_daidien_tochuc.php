...
$objFieldInfo->getList(" AND sub_cat_id='".SUB_TC_TCDT_THONGTIN_NGUOI_DAIDIEN_DOITAC."'", " ORDER BY sort asc");
$icon = "";
$i=0;
...
?>
	...
	<section class="col col-3 <?php if($rs['alias']=='menh') echo "field_hidden";?>">
		...
		<label class="input">
			...
			<input type="text" name="gr12_<?php echo SUB_TC_TCDT_THONGTIN_NGUOI_DAIDIEN_DOITAC;?>_<?php echo $rs['alias']?>[]" id="gr12_<?php echo SUB_TC_TCDT_THONGTIN_NGUOI_DAIDIEN_DOITAC;?>_<?php echo $rs['alias']?>" value="<?php echo $valueData;?>">
		</label>	
	</section>
	<?php endif;?>
	...
	<section class="col col-3">
		...
		<label class="textarea">
			...
			<textarea name="gr12_<?php echo SUB_TC_TCDT_THONGTIN_NGUOI_DAIDIEN_DOITAC;?>_<?php echo $rs['alias']?>[]" id="<?php echo $rs['alias']?>"><?php echo $valueData;?></textarea>											
		</label>
	</section>
	<?php endif; ?>
	...
	<section class="col col-3">
		<label class="label"><?php echo $rs['name']?></label>
		<label class="select">
			<select name="gr12_<?php echo SUB_TC_TCDT_THONGTIN_NGUOI_DAIDIEN_DOITAC;?>_<?php echo $rs['alias']?>[]" id="<?php echo $rs['alias']?>">
				<?php
					$fieldId = $rs['id'];
					$objOptionField->getList(" AND field_id=$fieldId", "");
					while ($r=$objOptionField->Fetch_Assoc()) { ?>
